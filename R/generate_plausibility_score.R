...
f_generate_score_table_word <- function(score_list){
  row_1 <- c('Percentage of flagged obsevations', 'Incl', 
             '0-2.5: 0 pts', 
             '>2.5-5.0: 5 pts', 
             '>5.0-7.5: 10 pts', 
             '>7.5: 20 pts',
             score_list$flagged_data)
  row_2 <- c('Significance of sex ratio difference', 'Incl', 
             '>0.1: 0 pts', 
             '>0.05: 2 pts', 
             '>0.001: 4 pts', 
             '<=0.001: 10 pts',
             score_list$overall_sex)
  row_3 <- c('Significance of age ratio difference (6-29 vs 30-59 months old)', 'Incl', 
             '>0.1: 0 pts', 
             '>0.05: 2 pts', 
             '>0.001: 4 pts', 
             '<=0.001: 10 pts',
             score_list$overall_age)
  row_4 <- c('Digit preference score - weight', 'Incl', 
             '0-7: 0 pts', 
             '8-12: 2 pts', 
             '13-20: 4 pts', 
             '>20: 10 pts',
             score_list$dps_weight)
  row_5 <- c('Digit preference score - height', 'Incl', 
             '0-7: 0 pts', 
             '8-12: 2 pts', 
             '13-20: 4 pts', 
             '>20- 10 pts',
             score_list$dps_height)
  row_6 <- c('Digit preference score - MUAC', 'Incl', 
             '0-7:  0 pts', 
             '8-12:  2 pts', 
             '13-20:  4 pts', 
             '>20-  10 pts',
             score_list$dps_muac)
  row_7 <- c('Standard Deviation of WHZ', 'Excl', 
             '<1.1 & >0.9: 0 pts', 
             '<1.15 & >0.85: 5 pts', 
             '<1.20 & >0.80: 10 pts', 
             '>=1.20 & <=0.80: 20 pts',
             score_list$std_weight)
  row_8 <- c('Skewness of WHZ', 'Excl', 
             '<+-0.2: 0 pts', 
             '<+-0.4: 1 pts', 
             '<+-0.6: 3 pts', 
             '>+-0.6: 5 pts',
             score_list$skew)
  row_9 <- c('Kurtosis of WHZ', 'Excl', 
             '<+-0.2: 0 pts', 
             '<+-0.4: 1 pts', 
             '<+-0.6: 3 pts', 
             '>+-0.6: 5 pts',
             score_list$kur)
  row_10 <- c('Poisson distributed prevalence of WHZ < -2', 'Excl', 
             '>0.05: 0 pts', 
             '>0.01: 1 pts', 
             '>0.001: 3 pts', 
             '<=0.001: 5 pts',
             score_list$poisson_score)
  row_11 <- c('Total penalty points: ', '', 
              '0-9',
              '10-14',
              '15-24',
              '>=25',
  ...
  colnames(score_list_table) <- c('Criterion', 'Flags', 'Excellent', 
                                  'Good', 'Acceptable', 'Problematic', 'Result')
